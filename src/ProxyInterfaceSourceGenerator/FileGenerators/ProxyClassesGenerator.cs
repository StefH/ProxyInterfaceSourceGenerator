...
internal partial class ProxyClassesGenerator : BaseGenerator, IFilesGenerator
{
    ...
    private bool TryGenerateFile(ProxyData pd, [NotNullWhen(true)] out FileData? fileData)
    {
        ...
        var code = CreateProxyClassCode(pd, targetClassSymbol, extendsProxyClasses, interfaceName, className, constructorName);
        ...
        string constructorName)
    {
        ...
        var properties = GeneratePublicProperties(targetClassSymbol, proxyData);
        var methods = GeneratePublicMethods(targetClassSymbol, proxyData);
        ...
        var accessibility = proxyData.Accessibility == ProxyClassAccessibility.Internal ? "internal" : "public";
